...
import ListSubCourses from './ListSubCourse';
...
const ListCourses: NextPage = ({ data }) => {
        ...
        <>
                ...
                <div className="grid grid-cols-1 gap-4 hover:grid-cols-1 ">
                    {data && data.map((val, index) =>
                        ...
                        <span onClick={()=>{handleEditOpen()}} style={{color:"blue"}} >Update Course</span>
                         <ListSubCourses data={data} id={val._id}/>  
